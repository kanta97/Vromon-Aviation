...
*/
  ...
  render() {
    console.log(this.state.controls, "updated data");
    let flag1 = false;
    let checker = [];
    ...
    if (
      ...
      this.state.tourTypeOption !== undefined &&
      this.state.tourTypeOption !== "" &&
      this.state.tourTypeOption !== null
    ) {
      console.log(this.state.tourTypeOption);
      tour = this.state.tourTypeOption.map((item) => {
        let hotel_id = `hotel_${item.tour_type}`;
        let price = `price_${item.tour_type}`;
        let currency = `currency_${item.tour_type}`;
            ...
            <FormGroup key={item.tour_type} row className="my-0">
              ...
              <Col xs="3">
                <FormGroup>
                  ...
                  <Input
                    type="select"
                    onChange={(event) =>
                      this.inputChangeHandler(event, currency)
                    }
                  >
                    <option key={"1"} value="">
                      Select Currency
              ...
              <Col xs="3">
                <FormGroup>
                  ...
                  <Input
                    ...
                    type="select"
                    onChange={(event) =>
                      this.inputChangeHandler(event, hotel_id)
                    }
                  >
              ...
              <Col xs="3">
                <FormGroup>
                  ...
                  <Input
                    ...
                    min="0"
                    onChange={(event) =>
                      this.inputChangeHandler(event, duration)
                    }
              ...
              <Col xs="1">
                <div className={"add_more_btn"}>
                  <Button
                    onClick={(event) =>
                      this.addMoreHotel(event, item.tour_type)
                    }
                    color={"primary"}
                  >
                    Add
      ...
      <div>
        <Col xs="12">
          <form>
            ...
            <div>
              <div className="text-center">
                <Button onClick={this.addFixedPackageHandle} color="primary">
