...
router.route('/package')
    .get(fixedpackages.search_package_by_destination);
router.route('/bookedpackage/search')
    .get(bookpackage.searchbookedpackage);

router.route('/upload')
    .post(fileupload.array('files', 20), fixedpackages.upload_file);

router.route('/package/book')
    .post(bookpackage.book_fixedpackage);

router.route('/packageBooking/cancel')
    .post(bookpackage.cancelBooking);

router.route('/packageBooking/update/:bookingReference')
    .put(bookpackage.update_fixedpackage);

router.route('/bookedPackage/statusUpdate')
    .put(bookpackage.update_booking_status);

router.route('/packages/featured/:limit?/:offset?')
    .get(featuredPackage.list_all_featuredpackage);


router.route('/hotel')
    .post(hotel.create_hotel);
...
router.route('/hotels/:limit?/:offset?')
    .get(hotel.list_all_hotel);
...
router.route('/transportation')
    .post(transportation.create_transportation);

router.route('/transportations/:limit?/:offset?')
    .get(transportation.list_all_transportation);

router.route('/transportation/:transportationid')
...
router.route('/activitys/:limit?/:offset?')
    .get(activity.list_all_activity);
...
router.route('/activity/location/:customlocationid')
    .get(activity.read_activity_customlocation);

router.route('/customPackageLocation')
    .post(customPackageLocation.create_customPackageLocation);

router.route('/customPackageLocations/:limit?/:offset?')
    .get(customPackageLocation.list_all_customPackageLocation);


router.route('/customPackageLocation/:id')
...
router.route('/tour_types')
    .get(tourType.list_all_tour_type);

router.route('/promo')
    .post(promo.create_promo);

router.route('/promo/user')
    .post(promo.assign_user);

router.route('/promoCode/check')
    .post(promo.check_promo);


router.route('/notification')
    .post(notification.create_notification);

router.route('/notification/dispatcher')
...
router.route('/promo/search')
    .get(promo.get_promo_by_criteria);



router.route('/package/custom/build')
    .post(custompackage.Build_Custom_Package);

router.route('/package/custom/book')
    .post(custompackage.bookCustomPackage);
router.route('/package/custom/update')
    .post(custompackage.updateCustomPackage);

router.route('/payment/ipn/:tran_id')
    .get(payment.listen_ipn);
